...
def get_zk_response(ID=None, ID_type='system', u_agent=USER_AGENT):
    '''
    Form and a Url to GET a json response from zkill of 
    ...
    this function returns a data structure with the
    response
    ...
    # these are fetch modifiers.  the applied 
